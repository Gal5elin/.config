...
myStartupHook = do
   ...
   -- spawnOnce "xargs xwallpaper --stretch < ~/.xwallpaper"
    ...
    spawnOnce "feh --randomize --bg-fill /home/gal5elin/Pictures/wallpapers/"  -- feh set random wallpaper
...
--threeCol = renamed [Replace "threeCol"]
  --         $ smartBorders
    --       $ windowNavigation
--      <Del>--    $ addTabs shrinkText myTabTheme
  --         $ subLayout [] (smartBorders Simplest)
    --       $ limitWindows 7
...
myWorkspaces = [" dev ", " www ", " file ", " game ", " chat ", " vbox ", " mus ", " vid ", " gfx "]
